    ...
    <section>
        ...
        <section class="">
            <section class="head">
                ...
                <figure class="info">
                    <figure>Welcome to VKScatter</figure>
                    <figure>Let's get started setting up your VKScatter.</figure>
                </figure>
            ...
            <section class="selected-item scrollable">
                ...
                <figure class="description">Read through the terms below fully so that you understand how both VKScatter and you are protected.</figure>
                ...
                <section class="split-panels">
                    ...
                    <section class="info-box">
                        ...
                        <figure class="terms">
                            ...
                            VKScatter Desktop (the "Service") provides single application for managing multiple blockchain accounts, identities, and reputations; allowing other applications to
                            interact with VKScatter to provide Identity authentication and reputation as well as digital signatures for use on various blockchains or other proofs. Any accompanying materials
                            such as tutorials, code, written documentation and other content issued by VKScatter (the "Content") also falls under this agreement.
                            <br><br>
                            ...
                            <br><br>
                            By using VKScatter you are accepting the Terms (the "Terms" or "Terms of Use"), please read them thoroughly before using the Service.
                            <b>
                                ...
                                rules and conditions of participation issued by VKScatter from time to time. If you do not agree to the Terms, then you may not access or use the Content or Services.
                            </b>
                            ...
                            VKScatter reserves the right, at its sole discretion, to modify or replace the Terms of Use at any time.
                            ...
                            <br><br>
                            VKScatter is a global platform and by accessing the Site or Services, you are representing and warranting that, you are of the legal age of majority in your jurisdiction as is required
                            ...
                            with the laws of your jurisdiction and acknowledge that VKScatter is not liable for your compliance with such laws.
                            ...
                            When setting up VKScatter, you will be responsible for keeping your own account secrets, which may be a twelve-word seed phrase, a backup file, passwords, keypairs, or
                            other locally stored secret information. VKScatter encrypts this information locally with a strong seed derived from the password you provide, that we never send to our servers.
                            You agree to (a) never use the same password for VKScatter that you have ever used outside of this service; (b) keep your secret information and password confidential and do not share them with anyone else.
                            VKScatter cannot and will not be liable for any loss or damage arising from your failure to comply with this section.
                            By using VKScatter you recognize yourself as the sole legal owner of your own secrets, keys, passwords, seed phrases, and other private data.
                            ...
                            particular purpose or non-infringement. You acknowledge that VKScatter has no control over, and no duty to take any action regarding: which users gain access to or use the
                            ...
                            You release VKScatter from all liability for you having acquired or not acquired Content through the Service. VKScatter makes no representations concerning any Content contained
                            in or accessed through the Service, and VKScatter will not be responsible or liable for the accuracy, copyright compliance, legality or decency of material contained in or accessed
                            through the Service.
                            <br><br>
                            ...
                            VKScatter and the supported blockchains and tokens could be impacted by one or more regulatory inquiries or regulatory action, which could impede or limit the ability of Scatter to continue to develop,
                            ...
                            To the extent possible, VKScatter intends to update the protocols underlying the Service to account for any advances in cryptography and to incorporate additional security measures, but does not guarantee or
                            ...
                            activities taking place on the supported blockchains. You acknowledge these risks and represent that VKScatter cannot be held liable for such fluctuations in both time and costs.
                            <br><br>
                            ...
                            and represent that blockchain applications can be written maliciously or negligently, that VKScatter cannot be held liable for your interaction with such applications and that
                            ...
                            You agree to release and to indemnify, defend and hold harmless VKScatter and its parents, subsidiaries, affiliates and agencies, as well as the officers, directors, employees,
                            ...
                            defamation or invasion of privacy. VKScatter reserves the right, at its own expense, to assume exclusive defense and control of any matter otherwise subject to indemnification by you and, in such case,
                            you agree to cooperate with VKScatter in the defense of such matter.
                            ...
                            All title, ownership and intellectual property rights in and to the Service are owned by VKScatter or its licensors. You acknowledge and agree that the Service contains
                            ...
                            modify, rent, lease, loan, sell, distribute, perform, display or create derivative works based on the Service, in whole or in part. VKScatter issues licenses for Scatter's various code-bases,
                            ...
                            The Service provides, or third parties may provide, links to other accessible internet websites, applications or resources. Because VKScatter might have no control over such sites,
                            applications and resources, you acknowledge and agree that VKScatter is not responsible for the availability of such external sites, applications or resources, and does not endorse and is not
                            ...
                            VKScatter may terminate or suspend all or part of the Service and your VKScatter access immediately, without prior notice or liability, if you breach any of the terms or conditions of the Terms.
                            ...
                            <br><br>
                            VKScatter’s Copyright Agent can be reached at:<br>
                            ...
                            If you opt-out of these arbitration provisions, VKScatter also will not be bound by them.

                            <br><br>
                            <h2>13.7 Changes to this Section</h2>

                            VKScatter will provide 60-days’ notice of any changes to this section. Changes will become effective on the 60th day, and will apply prospectively only to any claims
                            arising after the 60th day.
                            <br><br>
                            For any dispute not subject to arbitration you and VKScatter agree to submit to the personal and exclusive jurisdiction of and venue in the federal and state courts located
                            ...
                            <br><br>
                            The Terms and the relationship between you and VKScatter shall be governed by the laws of the State of New York without regard to conflict of law provisions.
                            ...
                            These Terms (and any additional terms, rules and conditions of participation that VKScatter may post on the Service) constitute the entire agreement between you and
                            VKScatter with respect to the Service and supersedes any prior agreements, oral or written, between you and VKScatter. In the event of a conflict between these Terms and
                            ...
                            The failure of VKScatter to exercise or enforce any right or provision of the Terms shall not constitute a waiver of such right or provision. If any provision of the Terms
