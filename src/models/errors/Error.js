...
export default class Error {
    ...
    static locked(){
        return new Error(ErrorTypes.LOCKED, "The user's TTMC Wallet is locked. They have been notified and should unlock before continuing.")
    }
    ...
    static signatureAccountMissing(){
        return this.signatureError("account_missing", "You are trying to sign a request with an account that isn't currently linked or doesn't exist in the user's TTMC Wallet");
    }

    static noNetwork(){
        return this.signatureError("no_network", "This user does not have this network in their TTMC Wallet.");
    }
