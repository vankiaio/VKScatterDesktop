    ...
    static async initialize(){
        ...
        if(certs && certs.hasOwnProperty('key') && certs.hasOwnProperty('cert')){
            ...
            PopupService.push(Popup.prompt("Couldn't fetch certificates",
                'There was an issue trying to fetch the certificates which allow TTMC Wallet to run on SSL. This is usually caused by proxies, firewalls, and anti-viruses.'))
        }
