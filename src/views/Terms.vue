    ...
    <section>
        ...
        <section class="panel-container">
            ...
            <section class="selected-item scrollable">
                ...
                <figure class="description">Read through the terms below fully so that you understand how both TTMC Wallet and you are protected.</figure>
                ...
                <section class="split-panels">
                    ...
                    <section class="info-box">
                        ...
                        <figure class="terms">
                            ...
                            TTMC Wallet Desktop (the "Service") provides single application for managing multiple blockchain accounts, identities, and reputations; allowing other applications to
                            interact with TTMC Wallet to provide Identity authentication and reputation as well as digital signatures for use on various blockchains or other proofs. Any accompanying materials
                            such as tutorials, code, written documentation and other content issued by TTMC Wallet (the "Content") also falls under this agreement.
                            <br><br>
                            ...
                            <br><br>
                            By using TTMC Wallet you are accepting the Terms (the "Terms" or "Terms of Use"), please read them thoroughly before using the Service.
                            <b>
                                ...
                                rules and conditions of participation issued by TTMC Wallet from time to time. If you do not agree to the Terms, then you may not access or use the Content or Services.
                            </b>
                            ...
                            <br><br>
                            TTMC Wallet is a global platform and by accessing the Site or Services, you are representing and warranting that, you are of the legal age of majority in your jurisdiction as is required
                            ...
                            with the laws of your jurisdiction and acknowledge that TTMC Wallet is not liable for your compliance with such laws.
                            ...
                            When setting up TTMC Wallet, you will be responsible for keeping your own account secrets, which may be a twelve-word seed phrase, a backup file, passwords, keypairs, or
                            other locally stored secret information. TTMC Wallet encrypts this information locally with a strong seed derived from the password you provide, that we never send to our servers.
                            You agree to (a) never use the same password for TTMC Wallet that you have ever used outside of this service; (b) keep your secret information and password confidential and do not share them with anyone else.
                            TTMC Wallet cannot and will not be liable for any loss or damage arising from your failure to comply with this section.
                            By using TTMC Wallet you recognize yourself as the sole legal owner of your own secrets, keys, passwords, seed phrases, and other private data.
                            ...
                            particular purpose or non-infringement. You acknowledge that TTMC Wallet has no control over, and no duty to take any action regarding: which users gain access to or use the
                            ...
                            You release TTMC Wallet from all liability for you having acquired or not acquired Content through the Service. TTMC Wallet makes no representations concerning any Content contained
                            in or accessed through the Service, and TTMC Wallet will not be responsible or liable for the accuracy, copyright compliance, legality or decency of material contained in or accessed
                            through the Service.
                            <br><br>
                            ...
                            TTMC Wallet and the supported blockchains and tokens could be impacted by one or more regulatory inquiries or regulatory action, which could impede or limit the ability of TTMC Wallet to continue to develop,
                            ...
                            To the extent possible, TTMC Wallet intends to update the protocols underlying the Service to account for any advances in cryptography and to incorporate additional security measures, but does not guarantee or
                            ...
                            activities taking place on the supported blockchains. You acknowledge these risks and represent that TTMC Wallet cannot be held liable for such fluctuations in both time and costs.
                            <br><br>
                            ...
                            and represent that blockchain applications can be written maliciously or negligently, that TTMC Wallet cannot be held liable for your interaction with such applications and that
                            such applications may cause the loss of property or even identity. This warning and others later provided by TTMC Wallet in no way evidence or represent an on-going duty to alert
                            ...
                            You agree to release and to indemnify, defend and hold harmless TTMC Wallet and its parents, subsidiaries, affiliates and agencies, as well as the officers, directors, employees,
                            ...
                            defamation or invasion of privacy. TTMC Wallet reserves the right, at its own expense, to assume exclusive defense and control of any matter otherwise subject to indemnification by you and, in such case,
                            you agree to cooperate with TTMC Wallet in the defense of such matter.
                            ...
                            The Service provides, or third parties may provide, links to other accessible internet websites, applications or resources. Because TTMC Wallet might have no control over such sites,
                            applications and resources, you acknowledge and agree that TTMC Wallet is not responsible for the availability of such external sites, applications or resources, and does not endorse and is not
                            responsible or liable for any content, advertising, products or other materials on or available from such sites or resources. You further acknowledge and agree that TTMC Wallet shall not be responsible
                            ...
                            TTMC Wallet may terminate or suspend all or part of the Service and your TTMC Wallet access immediately, without prior notice or liability, if you breach any of the terms or conditions of the Terms.
                            ...
                            If you believe that your copyright or the copyright of a person on whose behalf you are authorized to act has been infringed, please provide TTMC Wallet's Copyright Agent a
                            ...
                            TTMC Wallet will provide 60-days’ notice of any changes to this section. Changes will become effective on the 60th day, and will apply prospectively only to any claims
                            arising after the 60th day.
                            <br><br>
                            For any dispute not subject to arbitration you and TTMC Wallet agree to submit to the personal and exclusive jurisdiction of and venue in the federal and state courts located
                            ...
                            <br><br>
                            The Terms and the relationship between you and TTMC Wallet shall be governed by the laws of the State of New York without regard to conflict of law provisions.
                            ...
                            These Terms (and any additional terms, rules and conditions of participation that TTMC Wallet may post on the Service) constitute the entire agreement between you and
                            TTMC Wallet with respect to the Service and supersedes any prior agreements, oral or written, between you and TTMC Wallet. In the event of a conflict between these Terms and
                            ...
                            The failure of TTMC Wallet to exercise or enforce any right or provision of the Terms shall not constitute a waiver of such right or provision. If any provision of the Terms
